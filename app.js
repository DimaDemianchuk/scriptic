(() => {
    ...
    let fullpage_isMobile = {
        ...
        any: function() {
            return fullpage_isMobile.Android() || fullpage_isMobile.BlackBerry() || fullpage_isMobile.iOS() || fullpage_isMobile.Opera() || fullpage_isMobile.Windows();
        }
    };
    const fullpage_flsModules = {};
    class FullPage {
        ...
        events() {
            ...
            if (fullpage_isMobile.iOS()) document.addEventListener("touchmove", (e => {
                e.preventDefault();
            }));
            this.setEvents();
        }
    ...
    if (document.querySelector("[data-fp]")) fullpage_flsModules.fullpage = new FullPage(document.querySelector("[data-fp]"), "");
